...
int main() {
    ...
    zeroMatrix<rows,columns>(C);
    cudaMemset(d_C, 0, Csize);
    esmm_sequential_shmem<<<dim3(1,1), dim3(4*4), 4*4*2*sizeof(float)>>>(rows, columns, inners, 4, d_A, d_B, d_C);
    cudaMemcpy(C, d_C, Csize, cudaMemcpyDeviceToHost);
    ...
    zeroMatrix<rows,columns>(C);
    cudaMemset(d_C, 0, Csize);
    esmm_sequential_shmem<<<dim3(2,2), dim3(2*2), 2*2*2*sizeof(float)>>>(rows, columns, inners, 2, d_A, d_B, d_C);
    cudaMemcpy(C, d_C, Csize, cudaMemcpyDeviceToHost);
    ...
    zeroMatrix<rows,columns>(C);
    cudaMemset(d_C, 0, Csize);
    esmm_shmem_multi<<<dim3(1,1), dim3(4), 4*4*2*sizeof(float)>>>(rows, columns, inners, 4, d_A, d_B, d_C);
    cudaMemcpy(C, d_C, Csize, cudaMemcpyDeviceToHost);
    printf("\n Multi -- 4x4 \n\n");
    printMatrix<rows, columns>(C);
    ...
    zeroMatrix<rows,columns>(C);
    cudaMemset(d_C, 0, Csize);
    esmm_shmem_multi<<<dim3(2,2), dim3(2), 2*2*2*sizeof(float)>>>(rows, columns, inners, 2, d_A, d_B, d_C);
    cudaMemcpy(C, d_C, Csize, cudaMemcpyDeviceToHost);
    printf("\n Multi tiled -- 2x2 \n\n");
    printMatrix<rows, columns>(C);
    ...
    zeroMatrix<rows,columns>(C);
    cudaMemset(d_C, 0, Csize);
    esmm_shmem_multi2<<<dim3(1,1), dim3(4), 4*4*2*sizeof(float)>>>(rows, columns, inners, 4, d_A, d_B, d_C);
    cudaMemcpy(C, d_C, Csize, cudaMemcpyDeviceToHost);
    printf("\n Multi 2 -- 4x4 \n\n");
    printMatrix<rows, columns>(C);
    ...
    zeroMatrix<rows,columns>(C);
    cudaMemset(d_C, 0, Csize);
    esmm_shmem_multi2<<<dim3(2,2), dim3(2), 2*2*2*sizeof(float)>>>(rows, columns, inners, 2, d_A, d_B, d_C);
    cudaMemcpy(C, d_C, Csize, cudaMemcpyDeviceToHost);
    printf("\n Multi 2 tiled -- 2x2 \n\n");
    printMatrix<rows, columns>(C);
